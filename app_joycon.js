...
const joyconL = new Gamecontroller('joycon(L)');
const joyconR = new Gamecontroller('joycon(R)');

joyconL.connect(function() {
  console.log('Joycon (L) connected!');
});
joyconR.connect(function() {
  console.log('Joycon (R) connected!');
});
